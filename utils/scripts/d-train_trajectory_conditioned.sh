...
python scripts/reinforcement_learning/rsl_rl/train_trajectory_conditioned.py \
  ...
  --traj-obs-key policy \
  --output-dir experiments/apr26/transformer_a2r2o0015_policy_n10_trajkey_policy_dropout05 \
  --experiment-name markovian_policy \
  --run-name "apr26-transformer_a2r2o0015_policy_n10_trajkey_policy_dropout05" \
  --wandb-mode online \
  --seed 42 \
  --epochs 100 \
  --batch-size 128 \
